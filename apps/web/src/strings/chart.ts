...
export const chart = {
  ...
  graph: {
    ...
    help: {
      scheduling: {
        FS: '等待任務完成，才能開始：上游任務完成後，下游任務才能開始執行（實線紅色，由左向右流向）。',
        SS: '等待任務開始，才能開始：上游任務開始後，下游任務才能開始執行（實線橘色，由左向右流向）。',
        FF: '等待任務完成，才能完成：上游任務完成後，下游任務才能完成結案（實線紫色，由左向右流向）。',
        SF: '等待任務開始，才能完成：上游任務開始後，下游任務才能完成結案（實線青色，由左向右流向）。',
      },
      operation:
